...
parser.add_argument("--negative_file", default="D:/Proj/embedded_reranking/OpenMatchV2/marco/train.negatives.tsv")
...
parser.add_argument("--doc_template", default="Title: <title> Text: <text>")
parser.add_argument("--query_template", type=str, default=None)
